...
/// AngryOxide configuration for CLI arg generation
#[derive(Debug, Clone)]
pub struct AoConfig {
...
pub fn build_args(config: &AoConfig) -> Result<Vec<String>> {
...
pub fn build_personality_args(personality: &str, base_config: &AoConfig) -> Result<Vec<String>> {
...
pub fn validate_config(config: &AoConfig) -> Result<()> {
