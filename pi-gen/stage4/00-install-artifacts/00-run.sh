...
# that already-built binary into the image.
#
# RUST_TARGET_TRIPLE is set in pi-gen/config based on PWNGHOST_BOARD
# (pi-zero-w -> arm-unknown-linux-gnueabihf; pi-zero-2w ->
